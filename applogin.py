...
def load_data_from_excel(file_path):
    ...
    login_details_df = pd.read_excel(file_path, sheet_name="Login Details")
    ...
    return courses, teachers, credit_points, time_slots, subject_with_teacher, login_details

# Path to your Excel file
file_path = 'C:\\Users\\HANI PATEL\\Desktop\\timetable excel.xlsx'

# Load data from Excel
courses, teachers, credit_points, time_slots, subject_with_teacher, login_details = load_data_from_excel(file_path)
...
def authenticate():
    ...
    if email in login_details and login_details[email] == password:
        return redirect("/dashboard")  # Redirect to a dashboard or main page
    else:
