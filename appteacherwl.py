...
def load_data_from_excel(file_path):
    ...
    for _, row in teachers_df.iterrows():
        ...
        teacher_workload[teacher] = workload  # Store initial workload
    ...
    return courses, teacher_workload, credit_points, time_slots, subject_with_teacher
...
def assign_teacher_based_on_workload(subject, subject_with_teacher):
    teacher1 = subject_with_teacher[subject]['teacher1']
    teacher2 = subject_with_teacher[subject]['teacher2']
    
    # Check current workloads
    current_workload1 = teacher_workload.get(teacher1, 0)
    current_workload2 = teacher_workload.get(teacher2, 0)

    # Assign based on lower current workload
    if current_workload1 < current_workload2:
        return teacher1
    else:
        return teacher2
...
def create_timetable(courses, teachers, credit_points, time_slots, subject_with_teacher):
    # timetable = {}
            ...
            for semester in courses[course]:
                ...
                for day in weekly_schedule:
                    ...
                    while current_time < end_time_dt:
                        ...
                        teacher = assign_teacher_based_on_workload(subject, subject_with_teacher)
                        ...
                        if is_teacher_available(teacher, day, current_time, next_time):
                            book_teacher(teacher, day, current_time, next_time)
...
#             courses, teachers, credit_points, time_slots, subject_with_teacher = load_data_from_excel(file_path)
#             # timetable = create_timetable(courses, teachers, credit_points, time_slots, subject_with_teacher)
...
def upload_file():
    if request.method == 'POST':
        ...
        # Call your create_timetable function here or handle it as needed
        create_timetable(courses, teachers, credit_points, time_slots, subject_with_teacher)
