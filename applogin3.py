...
#     ideal_teacher1_slots = (teacher_assignment_tracker[subject]['teacher1_count'] / max(1, sum(teacher_assignment_tracker[subject].values()))) * total_ratio
#     ideal_teacher2_slots = (teacher_assignment_tracker[subject]['teacher2_count'] / max(1, sum(teacher_assignment_tracker[subject].values()))) * total_ratio
#     # Assign the teacher who has a larger deficit in their ideal slots
#     if ideal_teacher1_slots < ratio1:
...
def index():
    ...
    return render_template('index3.html', course_list=course_list)
